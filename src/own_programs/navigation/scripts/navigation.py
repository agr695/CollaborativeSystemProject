...
class navigation():
    ...
    #     target_pose.twist.linear.x = (self.relative_x - self.local_pose.pose.position.x)*self.dt
    #     target_pose.twist.linear.z = ( (3 - self.relative_z) - self.local_pose.pose.position.z)*self.dt
    #

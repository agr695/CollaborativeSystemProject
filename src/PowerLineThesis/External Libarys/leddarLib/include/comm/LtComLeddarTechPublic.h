...
{
    /// \enum   _eLtCommSoftwareType
    /// \brief  Software type.
    typedef enum _eLtCommSoftwareType
    {
    ...
    typedef enum _eLtCommDataLevel
    {
    ...
    typedef enum _eLtCommGenericElementsIdCodes
    {
        ...
        LT_COMM_ID_AUTO_DATA_SERVER_PROTOCOL = 0x2503,               ///< (0x2503) {uint8_t} TCP or UDP see \ref _eLtCommProtocol
    ...
    typedef enum _eLtCommCfgSrvGenericRequestCodes
    {
    ...
    typedef enum _eLtCommGenericAnswerCodes
    {
    ...
    typedef enum _eLtCommDataSrvGenericRequestCodes
    {
    ...
    /// \enum   _eLtCommProtocol
    /// \brief  Protocol used for communication in
    typedef enum _eLtCommProtocol
    {
    ...
    /// \enum   eLtCommThresholdOptions
    /// \bried  Threshold options - Exclusives, only one should be enabled
...
#pragma pack(push, 1)
    ...
    /// \brief  LeddarTech protocol request header.
    // Total size       :   8 bytes
    ...
    /// \brief  LeddarTech protocol element format header structure.
    // Total size    : 8 bytes
    typedef struct
    {
...
#define LEDDARTECH_ID_ECHO_STATE                         LEDDARTECH_ID_COMPUTE(0x0002) // {uint8_t} - 0 = disable; !=0 = enable
    ...
    typedef enum _eLtCommDeviceType
    {
...
/// \brief Device types register address.
    typedef enum _eLtCommDeviceTypeRegAddress
    {

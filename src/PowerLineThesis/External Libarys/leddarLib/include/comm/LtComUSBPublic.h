...
#pragma pack(push, 1)
    ...
    typedef enum _eLtComUsbSetupRequestCmd
    {
    ...
    typedef struct LtComUsbIdtAnswerIdentify
    {
        ...
        ///< running. See \ref LtComLeddarTech::eLtCommSoftwareType.

        uint32_t mOptions;              ///< Bit field that defines various device options (meaning defined for each platform).
        uint32_t mServerState;          ///< Identify server state. See \ref LtComLeddarTech::eLtCommIdtServerState.

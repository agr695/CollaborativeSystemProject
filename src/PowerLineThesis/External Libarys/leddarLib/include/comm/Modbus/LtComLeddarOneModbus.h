/// ****************************************************************************
///
/// \file      comm\Modbus\LtComLeddarOneModbus.h
///
...
#define ONE_WAIT_AFTER_REQUEST      5   //Time to wait in ms after a request to be sure the next request is properly transmitted. 2ms should be enough in most cases

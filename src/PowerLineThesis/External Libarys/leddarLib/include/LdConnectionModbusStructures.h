...
#pragma pack(push, 1)
        ...
        struct sModbusReadDataAnswer
        {
            ...
            uint8_t     mData[MODBUS_MAX_SIZE - sizeof(sModbusHeader) - sizeof(uint32_t) - sizeof(uint8_t) - MODBUS_CRC_SIZE];  // Size must be 247 bytes...
        };
        ...
        struct sModbusPacket
        {
            ...
            union
            {
                ...
                uint8_t mRawDataArray[MODBUS_MAX_SIZE - sizeof(sModbusHeader)];     // at least two bytes is reserved for Modbus CRC16...
            };
        };
    }
#pragma pack(pop)

...
// *****************************************************************************
// Function: LtStringUtils::StringToInt
//
...
// *****************************************************************************
// Function: LtStringUtils::StringToUInt
//
...
// *****************************************************************************
// Function: LtStringUtils::StringToFloat
//
...
// *****************************************************************************
// Function: LtStringUtils::HexStringToByteArray
//
/// \brief   Convert a string of hex (ex: FE01) to an array of byte (ex: 0xFE01 )
///
/// \param   aHexString String to convert.
/// \param   aHexByte   Array of bytes (out)
///
/// \author  Patrick Boulay
///
/// \since   December 2016
...
// *****************************************************************************
// Function: LtStringUtils::ByteArrayToHexString
//
/// \brief   Convert an array of bytes to a string
///
/// \param   aHexByte   Array of bytes
/// \param   aLength    Size of the array of bytes
///
/// \return  Reutrns a string containing the hex values
///
/// \author  Patrick Boulay
///
/// \since   December 2016
...
// *****************************************************************************
// Function: LtStringUtils::StringToIp4Addr
//
/// \brief   Convert an IPv4 string to a uint32_t (network byte order).
///
/// \param   aIpAddrStr IP address in format (xxx.xxx.xxx.xxx)
///
/// \return  Returns an ip 4 address in long (network byte order).
///
/// \throw   LtInfoException on conversion fail
///
/// \author  Patrick Boulay
///
/// \since   March 2017
...
// *****************************************************************************
// Function: LtStringUtils::Ip4AddrToString
//
/// \brief   Convert a uint32_t (network byte order) to an IPv4 string.
///
/// \param   aIpAddr IP address uint32_t format
///
/// \return  Reutrns String in xxx.xxx.xxx.xxx format.
///
/// \author  Patrick Boulay
///
/// \since   March 2017
...
/// *****************************************************************************
/// Function: LtStringUtils::Ip4PortStringToValues
///
/// \brief   Convert a string IP:port to an IP string and a port uint16
///
/// \param   aIpAddr IP address uint32_t format
/// \param   aIp Pointer to a string that will hold the IP
/// \param   aPort Pointer to an uint that will hold the port
///
/// \author  David Levy
///
/// \since   February 2018
...
#ifdef _WIN32
// *****************************************************************************
// Function: LtStringUtils::Utf8Encode
//
/// \brief   Convert a windows widechar array to multibyte array (UTF8)
///
/// \param   Windows (unicode) wstring
///
...
///
/// \return  Vector of string of the line splitted.
///
/// \author  Patrick Boulay
///
/// \since   December 2017

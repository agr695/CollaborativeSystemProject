...
/// Module..: Leddar
///
/// \file   LdSensorM16Laser.cpp.
///
/// \brief  Implements the M16Laser sensor class
///
/// \since  August 2018
///
...
{
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_EDITABLE, LdPropertyIds::ID_START_TRACE,
                              LtComM16::M16_ID_CFG_START_TRACE_INDEX, 4 ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_INFO, LdProperty::F_NONE, LdPropertyIds::ID_START_TRACE_LIMITS,
                              LtComM16::M16_ID_LIMIT_START_TRACE_INDEX, 4 ) );
}
...
///                 anything > 0 to compute for a theorical value
///
...
LeddarDevice::LdSensorM16Laser::GetStartTraceDistance( int aValue )
{
    ...
    {
        throw std::logic_error( "Wrong argument value (start trace is >=0)." );
    }

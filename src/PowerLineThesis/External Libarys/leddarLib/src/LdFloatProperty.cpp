...
///                     floating point * scale. If the scale is 1, the value
...
LeddarCore::LdFloatProperty::SetRawValue( size_t aIndex, int32_t aValue )
{
    ...
    {
        throw std::out_of_range( "Value outside the limits. Property id: " + LeddarUtils::LtStringUtils::IntToString( GetId() ) );
    }
...
LeddarCore::LdFloatProperty::SetValue( size_t aIndex, float aValue )
{
    ...
    else
    {
        ...
        if( lNewValueStream.str() != lOldValueStream.str() )
        {

    ...
    LdSensor( aConnection )
{
    ...
    mProperties->AddProperty( new LdTextProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_SERIAL_NUMBER, 0, 32, LdTextProperty::TYPE_ASCII,
                              "Serial Number" ) );
    mProperties->AddProperty( new LdTextProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_DEVICE_NAME, 0, 32, LdTextProperty::TYPE_ASCII,
                              "Device Name" ) );
    mProperties->AddProperty( new LdTextProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_PART_NUMBER, 0, 32, LdTextProperty::TYPE_ASCII,
                              "Part Number" ) );
    mProperties->AddProperty( new LdTextProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_SOFTWARE_PART_NUMBER, 0, 32, LdTextProperty::TYPE_ASCII,
                              "Software Part Number" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_FIRMWARE_VERSION_STR, 0, 2, "Firmware Version" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_BOOTLOADER_VERSION, 0, 2, "Bootloader Version" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_FPGA_VERSION, 0, 2, "FPGA Version" ) );
    mProperties->AddProperty( new LdBitFieldProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_OPTIONS, 0, 4, "Options (Internal Use)" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_DEVICE_TYPE, 0, 2, "Device Type" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_DISTANCE_SCALE, 0, 4, "Distance Scale" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_AMP_SCALE, 0, 4, "Amplitude Scale" ) );
    ...
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_COM_SERIAL_PORT_LOGICAL_PORT, 0, 1,
                              "Serial Port Logical Port" ) );
    mProperties->AddProperty( new LdEnumProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_EDITABLE, LdPropertyIds::ID_COM_SERIAL_PORT_BAUDRATE, 0, 4, "Serial Port Baudrate" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_COM_SERIAL_PORT_DATA_BITS, 0, 1, "Serial Port Data Bits" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_COM_SERIAL_PORT_PARITY, 0, 1, "Serial Port Parity" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_COM_SERIAL_PORT_STOP_BITS, 0, 1, "Serial Port Stop Bits" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_EDITABLE, LdPropertyIds::ID_COM_SERIAL_PORT_ADDRESS, 0, 1,
                              "Serial Port Serial Port Address" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_COM_SERIAL_PORT_FLOW_CONTROL, 0, 1,
                              "Serial Port Flow Control" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_EDITABLE, LdPropertyIds::ID_COM_SERIAL_PORT_MAX_ECHOES, 0, 2,
                              "Serial Port Maximum Echoes" ) );
    mProperties->AddProperty( new LdEnumProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_EDITABLE, LdPropertyIds::ID_COM_SERIAL_PORT_ECHOES_RES, 0, 1,
                              "Serial Port Distance Resolution" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_COM_SERIAL_PORT_CURRENT_PORT, 0, 1,
                              "Serial Port Current Port Number" ) );

    // CAN port properties
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_COM_CAN_PORT_LOGICAL_PORT, 0, 1, "CAN Port Logical Port" ) );
    mProperties->AddProperty( new LdEnumProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_EDITABLE, LdPropertyIds::ID_COM_CAN_PORT_BAUDRATE, 0, 4, "CAN Port Baud Rate" ) );
    mProperties->AddProperty( new LdEnumProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_EDITABLE, LdPropertyIds::ID_COM_CAN_PORT_FRAME_FORMAT, 0, 1, "CAN Port Frame Format" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_EDITABLE, LdPropertyIds::ID_COM_CAN_PORT_TX_MSG_BASE_ID, 0, 4,
                              "CAN Port Base Tx Id" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_EDITABLE, LdPropertyIds::ID_COM_CAN_PORT_RX_MSG_BASE_ID, 0, 4,
                              "CAN Port Base Rx Id" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_EDITABLE, LdPropertyIds::ID_COM_CAN_PORT_MAX_ECHOES, 0, 1,
                              "CAN Port Maximum Echoes" ) );
    mProperties->AddProperty( new LdEnumProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_EDITABLE, LdPropertyIds::ID_COM_CAN_PORT_ECHOES_RES, 0, 2,
                              "CAN Port Distance Resolution" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_EDITABLE, LdPropertyIds::ID_COM_CAN_PORT_PORT_MAILBOX_DELAY, 0, 2,
                              "CAN Port Inter-Message Delay" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_EDITABLE, LdPropertyIds::ID_COM_CAN_PORT_PORT_ACQCYCLE_DELAY, 0, 2,
                              "CAN Port Inter-Cycle Delay" ) );

    mProperties->AddProperty( new LdTextProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_CARRIER_PART_NUMBER, 0, 32, LdTextProperty::TYPE_ASCII,
                              "Carrier Board Part Number" ) );
    mProperties->AddProperty( new LdTextProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_CARRIER_SERIAL_NUMBER, 0, 32, LdTextProperty::TYPE_ASCII,
                              "Carrier Board Serial Number" ) );
    mProperties->AddProperty( new LdBitFieldProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_CARRIER_OPTIONS, 0, 4, "Option (Internal Use)" ) );
    mProperties->AddProperty( new LdIntegerProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_CARRIER_FIRMWARE_VERSION, 0, 4,
                              "Carrier Board Firmware Version" ) );
    mProperties->AddProperty( new LdTextProperty( LdProperty::CAT_CONFIGURATION, LdProperty::F_NONE, LdPropertyIds::ID_CARRIER_FIRMWARE_PART_NUMBER, 0, 32, LdTextProperty::TYPE_ASCII,
    ...
    GetProperties()->GetIntegerProperty( LdPropertyIds::ID_COM_CAN_PORT_PORT_MAILBOX_DELAY )->SetLimits( 0, std::numeric_limits<uint16_t>::max() );
...
LdSensorVu8Modbus::GetConfig( void )
{
    ...
    LeddarUtils::LtTimeUtils::Wait( LEDDARVU8_WAIT_AFTER_REQUEST );
    ...
    GetProperties()->GetTextProperty( LdPropertyIds::ID_SERIAL_NUMBER )->SetValue( 0, lServedId.mSerialNumber );
    GetProperties()->GetTextProperty( LdPropertyIds::ID_DEVICE_NAME )->SetValue( 0, lServedId.mDeviceName );
    GetProperties()->GetTextProperty( LdPropertyIds::ID_PART_NUMBER )->SetValue( 0, lServedId.mHardwarePartNumber );
    GetProperties()->GetTextProperty( LdPropertyIds::ID_SOFTWARE_PART_NUMBER )->SetValue( 0, lServedId.mSoftwarePartNumber );

    LeddarCore::LdIntegerProperty *lFirmwareVersion = GetProperties()->GetIntegerProperty( LdPropertyIds::ID_FIRMWARE_VERSION_STR );
    ...
    for( int i = 0; i < 4; i++ )
    {
        lFirmwareVersion->SetValue( i, lServedId.mFirwareVersion[ i ] );
        lBootloaderVersion->SetValue( i, lServedId.mBootloaderVersion[ i ] );
    }

    GetProperties()->GetIntegerProperty( LdPropertyIds::ID_FPGA_VERSION )->SetValue( 0, lServedId.mFpgaVersion );
    GetProperties()->GetBitProperty( LdPropertyIds::ID_OPTIONS )->SetValue( 0, lServedId.mDeviceOptions );
    GetProperties()->GetIntegerProperty( LdPropertyIds::ID_DEVICE_TYPE )->SetValue( 0, lServedId.mDeviceId );
...
LdSensorVu8Modbus::GetConstants( void )
{
    ...
    LeddarCore::LdIntegerProperty *lAmpScale = GetProperties()->GetIntegerProperty( LdPropertyIds::ID_AMP_SCALE );

    lDistScale->SetValue( 0, LEDDARVU8_DISTANCE_SCALE );
    lAmpScale->SetValue( 0, LEDDARVU8_AMPLITUDE_SCALE );
...
LdSensorVu8Modbus::GetSerialConfig( void )
{
    ...
    GetProperties()->GetIntegerProperty( LeddarCore::LdPropertyIds::ID_COM_SERIAL_PORT_CURRENT_PORT )->SetValue( 0, lCurrentSerial );
    ...
    for( int i = 0; i < lNumberSerial; ++i )
    {
        ...
        lSPDataBits->SetValue( i, lSerialPortSetting->mDataSize );
        lSPParity->SetValue( i, lSerialPortSetting->mParity );
        lSPStopBits->SetValue( i, lSerialPortSetting->mStopBits );
        lSPPortAddress->SetValue( i, lSerialPortSetting->mAddress );
        lSPFlowControl->SetValue( i, lSerialPortSetting->mFlowControl );
        lSPLogicalPort->SetValue( i, lSerialPortSetting->mLogicalPortNumber );
...
LdSensorVu8Modbus::GetCanConfig( void )
{
    ...
    GetProperties()->GetIntegerProperty( LeddarCore::LdPropertyIds::ID_COM_CAN_PORT_LOGICAL_PORT )->SetValue( 0, lCanPortSetting->mLogicalPortNumber );
    ...
    GetProperties()->GetIntegerProperty( LeddarCore::LdPropertyIds::ID_COM_CAN_PORT_PORT_MAILBOX_DELAY )->SetValue( 0, lCanPortSetting->mInterMsgDelay );
...
LdSensorVu8Modbus::GetCarrierInfoConfig( void )
{
    ...
    GetProperties()->GetTextProperty( LeddarCore::LdPropertyIds::ID_CARRIER_PART_NUMBER )->SetValue( 0, lCarrierInfo->mHardwarePartNumber );
    GetProperties()->GetTextProperty( LeddarCore::LdPropertyIds::ID_CARRIER_SERIAL_NUMBER )->SetValue( 0, lCarrierInfo->mHardwareSerialNumber );
    GetProperties()->GetBitProperty( LeddarCore::LdPropertyIds::ID_CARRIER_OPTIONS )->SetValue( 0, lCarrierInfo->mCarrierDeviceOption );
...
LdSensorVu8Modbus::GetCarrierFirmwareInfoConfig( void )
{
    ...
    for( int i = 0; i < 4; i++ )
    {
        lCarrierFirmwareVersion->SetValue( i, lCarrierFirmwareInfo->mFirmwareVersion[i] );
    }

    GetProperties()->GetTextProperty( LeddarCore::LdPropertyIds::ID_CARRIER_FIRMWARE_PART_NUMBER )->SetValue( 0, lCarrierFirmwareInfo->mFirmwarePartNumber );
        ...
        if( ( *lPropertyIter )->Modified() && ( ( *lPropertyIter )->GetDeviceId() != 0 || ( *lPropertyIter )->GetId() == LeddarCore::LdPropertyIds::ID_ACCUMULATION_EXP ) )
        {
            ...
            switch( ( *lPropertyIter )->GetType() )
            {
                ...
                case LeddarCore::LdProperty::TYPE_INTEGER:
                    lValue = dynamic_cast<LeddarCore::LdIntegerProperty *>( ( *lPropertyIter ) )->ValueT<uint32_t>();
                    break;
...
LdSensorVu8Modbus::SetCanConfig( void )
{
    ...
    lCanPortSettings->mInterMsgDelay = GetProperties()->GetIntegerProperty( LeddarCore::LdPropertyIds::ID_COM_CAN_PORT_PORT_MAILBOX_DELAY )->ValueT<uint16_t>();
